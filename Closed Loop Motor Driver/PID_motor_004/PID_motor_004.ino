...
#define DEBUG //comment this out for no serial output
...
volatile int data = 0;//incomeing I2C data will be stored here,Only 16bit int
...
cli();
  ...
  pinMode(10, 1);//PWM pin ,OCR1x
  pinMode(9, 1);//PWM pin ,OCR1x
//interrupt pin   
...
//I2C request ISR 
void requestEvent() {
  I2C_writeAnything((int16_t)(60000.0 / dt) * 14));
}
